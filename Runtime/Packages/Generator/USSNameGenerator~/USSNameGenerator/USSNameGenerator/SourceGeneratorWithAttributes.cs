...
public class SourceGeneratorWithAttributes : IIncrementalGenerator {
    const string Namespace = "Generators";
    const string AttributeName = "ReportAttribute";
...
{{
    ...
    static (ClassDeclarationSyntax, bool reportAttributeFound) GetClassDeclarationForSourceGen(
